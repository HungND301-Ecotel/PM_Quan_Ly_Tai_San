    ...
    if (selectedAsset) {
      const enrichedTaiSanConList =
        selectedAsset.taiSanConList?.map((item: any) => ({
          ...
          hienTrang: findById(assetsByDepartment, item.id)?.hienTrang || -1,
                    ...
                    <TableRow key={row.id || row.originalIndex} sx={bookStyles}>
                      <TableCell sx={bookStyles}>
                        {readOnly ? (
                          ...
                          <FieldAutoCompleted
                            ...
                            labelkey="tenTaiSan"
                            labelOption="id"
                            name={`taiSanConList.${row.originalIndex}.id`}
                            disabled={readOnly}
                            onChange={(val) => {
                              if (val) {
                                formik.setFieldValue(
                      ...
                      <TableCell>
                        {readOnly ? (
                          ...
                          <FieldInput
                            type="number"
                            name={`taiSanConList.${row.originalIndex}.soLuong`}
                            disabled
                          />
                        )}
                      </TableCell>
                      ...
                      <TableCell>
                        {readOnly ? (
                          ...
                          <FieldInput
                            name={`taiSanConList.${row.originalIndex}.ghiChu`}
                            disabled
                          />
                        )}
                      </TableCell>
