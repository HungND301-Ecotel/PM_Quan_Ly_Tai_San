...
import {
  ...
  useAssetRepairTimePageQuery,
} from "../../AssetManager/Mutation";
import { useConfig } from "../../../hooks/useContext";
import { useSelector } from "react-redux";

export default function AssetRepairTime() {
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
              ...
              <Box>
                ...
                >
                  Tài sản sắp đến kỳ sửa chữa
                </Typography>
                <Typography
                  variant="caption"
                  sx={{ color: "#94a3b8", fontWeight: 500 }}
                >
                  Theo dõi tài sản đến kỳ sửa chữa
                </Typography>
              </Box>
            </Box>
          </Grid>
                  ...
                  <TableRow>
                    <TableCell colSpan={6} sx={{ border: 0 }}>
                      ...
                      >
                        ...
                        >
                          Hiện tại không có tài sản nào sắp đến kỳ sửa chữa
                        </Typography>
                      </Box>
                    </TableCell>
                  </TableRow>
