...
public class TaiSanController {
    ...
    public ResponseEntity<ApiResponse<Object>> getPagedDaBanGiao(
        ...
        try {
            PageResponse<TaiSanDTO> result = taiSanService.getPagedByBanGiaoStatus(idcongty, page, size, sortBy, sortDir, search, idNhomTaiSan, iddonvihienthoi, true, soNgayThongBaoKiemDinh, trangThaiKiemDinh, trangThaiSuaChua);
    ...
    public ResponseEntity<ApiResponse<Object>> getByDonViBanDauPaged(
        ...
        try {
            PageResponse<TaiSanDTO> result = taiSanService.getByDonViBanDauPaged(idcongty, iddonvibandau, page, size, sortBy, sortDir,idNhomTaiSan, search, soNgayThongBaoKiemDinh, trangThaiKiemDinh, trangThaiSuaChua);
    ...
    @GetMapping("/sap-den-ky-sua-chua")
    public ResponseEntity<PageResponse<TaiSanSapDenKySuaChuaDTO>> getSapDenKySuaChua(
        @RequestParam("idCongTy") String idCongTy,
        @RequestParam("userId") String userId,
        @RequestParam(defaultValue = "0") int page,
        @RequestParam(defaultValue = "20") int size) {
        return ResponseEntity.ok(
            taiSanService.getDanhSachSapDenKySuaChua(idCongTy, userId, page, size)
        );
    }
    @PostMapping("/upload")
