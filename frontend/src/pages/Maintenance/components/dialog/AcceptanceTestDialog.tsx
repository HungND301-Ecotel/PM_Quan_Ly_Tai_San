      ...
      const assetsList = (jobAssignment?.danhSachTaiSan || []).map(
        (ts: any) => {
          return {
            ...
            maCongViec: ts?.maCongViec,
            noiDung:
              ts?.noiDung ||
              ts.noiDungCongViec ||
              ts.noiDung ||
              "Bảo dưỡng ; " + ts.tenTaiSan,
            soLuong: ts?.soLuong || 1,
            ghiChu: "",
          };
        },
      );
                      ...
                      (row: any, rowIdx: number) => (
                        <TableRow key={row.id}>
                          ...
                          <TableCell>
                            <FieldInput
                              title=""
                              name={`danhSachVatTu[${rowIdx}].kyHieu`}
                              noBorder={true}
                            />
                          </TableCell>
                          <TableCell>
                            <FieldInput
                              title=""
                              name={`danhSachVatTu[${rowIdx}].donViTinh`}
                              noBorder={true}
                            />
                          </TableCell>
                          <TableCell align="center">
                            <TextFieldNumber
                              name={`danhSachVatTu[${rowIdx}].soLuongThayThe`}
                              noBorder={true}
                            />
                          </TableCell>
                          <TableCell align="center">
                            <TextFieldNumber
                              name={`danhSachVatTu[${rowIdx}].soLuongThuHoi`}
                              noBorder={true}
                            />
                          </TableCell>
                          <TableCell>
                            <FieldInput
                              title=""
                              name={`danhSachVatTu[${rowIdx}].ghiChu`}
                              noBorder={true}
                            />
                          </TableCell>
                          <TableCell align="center">
                      ...
                      (row: any, rowIdx: number) => (
                        <TableRow key={row.id}>
                          ...
                          <TableCell>
                            <FieldInput
                              title=""
                              name={`danhSachTaiSan[${rowIdx}].maCongViec`}
                              noBorder={true}
                            />
                          </TableCell>
                          <TableCell>
                            <FieldInput
                              title=""
                              name={`danhSachTaiSan[${rowIdx}].noiDung`}
                              noBorder={true}
                              multiline
                              rows={3}
                            />
                          ...
                          <TableCell align="center">
                            <TextFieldNumber
                              name={`danhSachTaiSan[${rowIdx}].soLuong`}
                              noBorder={true}
                            />
                          </TableCell>
                          <TableCell>
                            <FieldInput
                              title=""
                              name={`danhSachTaiSan[${rowIdx}].ghiChu`}
                              noBorder={true}
                            />
                          </TableCell>
                          <TableCell align="center">
